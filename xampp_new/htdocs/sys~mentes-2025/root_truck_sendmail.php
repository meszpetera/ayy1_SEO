...
if ($resp == false){
    ...
    $_SESSION['pending_ajanlatkeres'] = array(
    ...
    redirect_in_site("?page=root_trucks&lang=$lang");
} else {
    ...
    $pdf->Cell(30, 0, iconv("UTF-8", "ISO-8859-2", "Targonca ajánlatkérés"));
    $pdf->Cell(35, 20);
    $pdf->Ln();

    $pdf->SetFont('Arial', 'b', 10);
    $pdf->Cell(30, 3, iconv("UTF-8", "ISO-8859-2", "A kért targonca leírása:"));
    $pdf->Ln();
    ...
    $email_subject = "Targonca ajánlatkérés"; // The Subject of the email 
