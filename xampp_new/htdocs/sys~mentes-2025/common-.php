...
*/  
  ...
  if (loggedin())
  {
    if(isauth())
      $admin = "<a href=\"?page=admin&amp;lang=$lang\">" . $language['userman_admin'] . "</a><br />";
    $user_box = '<div class="dUserBox" id="UserBox">' .
               '<div class="dUserInfo">' . $language['userman_welcome'] . '<span style="font-weight:bold;">' . $_SESSION['users_realname'] . '</span>!<br /><br />'.$admin.'<a href="sys/logout.php?lang=' . $lang . '">' . $language['userman_logout'] . '</a>' . 
               '</div></div>';
  }
  else
  {
    $user_box = '<div class="dUserBox" id="UserBox">' .
               ...
               '<a href="?page=' . $_REQUEST['page'] . '&lang=hun"><img src="https://'.($_SERVER['HTTP_HOST']).'/img/flags/hu.png" alt="Váltás magyar nyelvre"/></a>&nbsp;'.
               '<a href="?page=' . $_REQUEST['page'] . '&lang=eng"><img src="https://'.($_SERVER['HTTP_HOST']).'/img/flags/gb.png" alt="Switch to english"/></a>'.
