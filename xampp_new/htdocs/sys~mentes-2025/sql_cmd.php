...
$sql = array(
    ...
    "truck_details" => "SELECT
        ...
        `trucks`.`truck_type` AS `truck_type_id`,
				...
				(SELECT image_illustration FROM truck_images WHERE truck_images.`image_truck-id` = trucks.truck_id AND truck_images.image_id = trucks.`truck_default-image` LIMIT 1) AS `truck_default-image_label`,
        truck_cost,
    ...
    "truck_details_public" => "SELECT
        ...
        `truck_product_status`,
        (SELECT COUNT(*) FROM truck_images WHERE truck_images.`image_truck-id` = {1}) AS truck_imagecount
      FROM trucks WHERE `trucks`.truck_state IN ('A', 'B') AND `trucks`.truck_public = 1 AND `trucks`.truck_product_status<2 AND !( (`trucks`.`truck_depot`='3' OR `trucks`.`truck_depot`='0' ) AND `trucks`.`truck_sub-depot`='0') AND `trucks`.`truck_id` = '{1}'",
    ...
    "truck_getimage_label" => "SELECT image_illustration FROM truck_images WHERE truck_images.`image_truck-id` = {0} AND truck_images.image_id = {1}",
    ...
    "truck_search_saxonid_bovitett" => "SELECT `truck_saxon-id` FROM `trucks` WHERE `truck_saxon-id` LIKE '%[0]%'     AND NOT(`truck_depot`=3 AND `truck_sub-depot`=0)  ",
    ...
    "aktualis-filter_saxon-id" => "SELECT DISTINCT `truck_saxon-id` AS value FROM trucks WHERE `truck_state` = 'A' AND `truck_ispart` = {0} AND NOT(`truck_depot`=3 AND `truck_sub-depot`=0) ORDER BY `truck_saxon-id`",
    ...
    "aktualis-filter_functions-all" => "SELECT * FROM truck_functions_" . $lang . " ORDER BY value",
    ...
    "aktualis-filter_status_list" => "SELECT * FROM truck_status_[0] WHERE IF((SELECT count(*) FROM `trucks` WHERE `ID`=`truck_status` AND truck_public = 1 AND `trucks`.truck_product_status<2)>0,1,0) ORDER BY value",
    "aktualis-filter_type" => "SELECT * FROM truck_type_[0] WHERE `ispart` = {1} ORDER BY value",
    "aktualis-filter_type-all" => "SELECT * FROM truck_type_hun ORDER BY value",
    ...
    "aktualis-filter_base" => "SELECT `truck_saxon-id` FROM `trucks` WHERE NOT (`truck_depot` = 3 AND `truck_sub-depot` = 0) ORDER BY `truck_saxon-id`",
    ...
    "truckman_modify_truck" => "UPDATE `trucks` SET
      ...
      `truck_ispart` = {34},
      `truck_date` = NOW(),
      `truck_seller_name` = {35},
      `truck_seller_price` = {36},
      `truck_seller_date` = {37},
      `truck_seller_invoicenum`= {38},
      `truck_buyer_name`= {39},
      `truck_buyer_price`= {40},
      `truck_buyer_date`= {41},
      `truck_buyer_invoicenum`= {42},
      `truck_product_status` = {43},
      `truck_loc_x` = {44},
      `truck_loc_y` = {45},
      `truck_product_status_ext` = {46}
      WHERE `truck_id` = {0}",
    /*
      "truckman_modify_truck" => "UPDATE `trucks` SET
      `truck_make` = {1},
    ...
    "truckman_set_active" => "UPDATE `trucks` SET `truck_state` = 'A', `truck_product_status`=[1] WHERE `truck_id` = [0]",
    ...
    "excel_get-types_2" => "SELECT
      ...
      `ID`,
	  `ispart`
    FROM `truck_type_[0]` WHERE `ispart` = {1}
    ORDER BY
    IF( `ispart` =  0 , 0 , 1 ),
    IF( `ispart` =  2 , 0 , 1 ),
    IF( `ispart` =  5 , 0 , 1 ),
    ...
    "excel_get-sum-b" => "SELECT
      ...
      `ID`,
	  `ispart`
    FROM `truck_type_[0]` WHERE `ispart` = {1} OR `ispart` = {2} or `ispart` = {3} OR `ispart` = {4}
    ORDER BY
    IF( `ispart` =  0 , 0 , 1 ),
    IF( `ispart` =  2 , 0 , 1 ),
    IF( `ispart` =  5 , 0 , 1 ),
    ...
    "excel_get-sum-c" => "SELECT
      ...
      `ID`,
	  `ispart`
    FROM `truck_type_[0]` WHERE `ispart` = {1} OR `ispart` = {2} or `ispart` = {3}
    ORDER BY
    IF( `ispart` =  0 , 0 , 1 ),
    IF( `ispart` =  2 , 0 , 1 ),
    IF( `ispart` =  5 , 0 , 1 ),
    ...
    `value` ",
      ...
      CONCAT_WS(' ', (SELECT value FROM truck_location WHERE truck_location.depot = trucks.truck_depot AND truck_location.subdepot = 0), (SELECT value FROM truck_location WHERE truck_location.depot = trucks.truck_depot AND truck_location.subdepot = trucks.`truck_sub-depot` AND truck_location.subdepot != '0')) AS truck_location
    FROM `trucks`
    WHERE truck_public = 1 AND truck_product_status<2 AND `truck_type` = {1}
    ORDER BY
...
// WHERE `truck_type` = {1} AND `truck_ispart` = {2} AND `truck_state` = 'A'
    ...
    "excel_get-trucks_2date" => "SELECT
      ...
      CONCAT_WS(' ', (SELECT value FROM truck_location WHERE truck_location.depot = trucks.truck_depot AND truck_location.subdepot = 0), (SELECT value FROM truck_location WHERE truck_location.depot = trucks.truck_depot AND truck_location.subdepot = trucks.`truck_sub-depot` AND truck_location.subdepot != '0')) AS truck_location
    FROM `trucks`
    WHERE `truck_type` = {1} AND `truck_ispart` = {2} AND `truck_state` = 'A' AND `trucks`.truck_public = 1 AND `trucks`.truck_product_status<2
    ORDER BY
    IF( `truck_ispart` =  0 , 0 , 1 ),
    IF( `truck_ispart` =  2 , 0 , 1 ),
    IF( `truck_ispart` =  5 , 0 , 1 ),
...
// WHERE truck_public = {3} AND `truck_type` = {1} AND `truck_ispart` = {2} AND `truck_state` = 'A'
    ...
    "excel_get-trucks_2_R" => "SELECT
      ...
      CONCAT_WS(' ', (SELECT value FROM truck_location WHERE truck_location.depot = trucks.truck_depot AND truck_location.subdepot = 0), (SELECT value FROM truck_location WHERE truck_location.depot = trucks.truck_depot AND truck_location.subdepot = trucks.`truck_sub-depot` AND truck_location.subdepot != '0')) AS truck_location
    FROM `trucks`
    WHERE truck_public = 1 AND `trucks`.truck_product_status<2 AND `truck_saxon-id` LIKE \"R%\" AND `truck_type` = {1} AND `truck_ispart` = {2} AND `truck_state` = 'A'
    ORDER BY
    IF( `truck_ispart` =  0 , 0 , 1 ),
    IF( `truck_ispart` =  2 , 0 , 1 ),
    IF( `truck_ispart` =  5 , 0 , 1 ),
...
;",
    ...
    "promo:get" => "SELECT `truck_id` FROM `trucks` WHERE `truck_status` IN (1, 2, 11) AND (SELECT COUNT(*) FROM `truck_images` WHERE `truck_images`.`image_truck-id` = `trucks`.`truck_id`) > 0 AND `truck_cost` > 0 AND `truck_state` = 'A' AND `truck_public` = 1 AND `trucks`.truck_product_status<2",
