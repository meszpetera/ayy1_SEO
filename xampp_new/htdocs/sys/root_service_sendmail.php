...
if (!$resp->is_valid) {
    ...
    $_SESSION['pending_hibabejelentes'] = array(
        'company' => $_REQUEST['company'],
        'company_addr' => $_REQUEST['company_addr'],
        'company_inv_addr' => $_REQUEST['company_inv_addr'],
    ...
    redirect_in_site("?page=root_service&lang=$lang");
} else {
    ...
    $pdf->Cell(30, 0, iconv("UTF-8", "ISO-8859-2", "Hibabejelentés"));
    $pdf->Cell(35, 20);
    $pdf->Ln();
    ...
    $pdf->Cell(30, 0, iconv("UTF-8", "ISO-8859-2", $_REQUEST['truck']));
    $pdf->Ln();
    $pdf->Cell(35, 5);
    $pdf->Ln();

    $pdf->Cell(30, 0, iconv("UTF-8", "ISO-8859-2", "Évjárat:"));
    $pdf->Cell(30, 0, iconv("UTF-8", "ISO-8859-2", $_REQUEST['year']));
    $pdf->Cell(35, 15);
    $pdf->Ln();

    $pdf->Cell(30, 0, iconv("UTF-8", "ISO-8859-2", "Alvázszám:"));
    $pdf->Cell(30, 0, iconv("UTF-8", "ISO-8859-2", $_REQUEST['id']));
    $pdf->Cell(35, 15);
    $pdf->Ln();

    $pdf->Cell(30, 0, iconv("UTF-8", "ISO-8859-2", "Hiba leírása:"));
    $pdf->MultiCell(140, 4, iconv("UTF-8", "ISO-8859-2", $_REQUEST['faults']));
    $pdf->Cell(35, 15);
    $pdf->Ln();


    $pdf->SetFont('Arial', 'b', 14);
    $pdf->Cell(30, 0, iconv("UTF-8", "ISO-8859-2", "Egyéb:"));
    $pdf->Cell(35, 10);
    $pdf->Ln();

    $pdf->SetFont('Arial', 'b', 10);
    $pdf->Cell(30, 0, iconv("UTF-8", "ISO-8859-2", "Megjegyzés:"));
    $pdf->MultiCell(140, 4, iconv("UTF-8", "ISO-8859-2", $_REQUEST['comment']));
    $pdf->Cell(35, 15);
    $pdf->Ln();
    ...
    $pdf->Cell(35, 5);
    $pdf->Ln();
    $pdf->Cell(30, 0, iconv("UTF-8", "ISO-8859-2", "Cég címe:"));
    $pdf->Cell(30, 0, iconv("UTF-8", "ISO-8859-2", $_REQUEST['company_addr']));
    $pdf->Ln();
    $pdf->Cell(35, 5);
    $pdf->Ln();
    $pdf->Cell(30, 0, iconv("UTF-8", "ISO-8859-2", "Számlázási cím:"));
    $pdf->Cell(30, 0, iconv("UTF-8", "ISO-8859-2", $_REQUEST['company_inv_addr']));
    $pdf->Ln();
    $pdf->Cell(35, 5);
    $pdf->Ln();
    ...
    $email_subject = "Hibabejelentés"; // The Subject of the email 
    $email_message = "A hibabejelentés tartalma a csatolt pdf fájlban található."; // Message that the email has in it 
