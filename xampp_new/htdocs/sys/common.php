...
*/  
  ...
  if (loggedin())
  {
    ...
    $user_box_top = $language['userman_welcome'] . '<span style="font-weight:bold;">' . $_SESSION['users_realname'] . '</span>! <br> '.$admin.' | <a href="sys/logout.php?lang=' . $lang . '">' . $language['userman_logout'] . '</a>';
  }
  else
  {
    $user_box_bottom = '<div class="dUserBox" id="UserBox" style="font-size: 16px;">' .
