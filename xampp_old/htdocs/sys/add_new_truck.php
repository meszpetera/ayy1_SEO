<?php
  ...
  /*H - Vill�s targonc�k
    ...
    V - Vontat�k, golfaut�k

    K - Kieg�sz�t�k

    S - Sehov�

    M - Emel�szerkezetek, vill�k

    G - Gumik�penyek, felnik */
    ...
    // echo 'Ispart: ' . $ispart . ' Bet�: '.$betu.' <br>';
    ...
    $para = "
    	...
    	insert into `trucks`
         ...
         /*echo 'A t�tel >'.$saxonid.'< Saxon sz�mon felr�gz�tve.';
      ...
      $modetext = ' Mode: Felvitel (�j targonca)';
