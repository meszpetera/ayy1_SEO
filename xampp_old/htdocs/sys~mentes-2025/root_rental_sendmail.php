...
if (!$resp->is_valid) {
    ...
    $_SESSION['pending_berletiajanlat'] = array(
    ...
    redirect_in_site("?page=root_rental&lang=$lang");
} else {
    ...
    $pdf->Cell(30, 0, iconv("UTF-8", "ISO-8859-2", "Bérleti ajánlatkérés"));
    $pdf->Cell(35, 20);
    $pdf->Ln();

    $pdf->SetFont('Arial', 'b', 10);
    $pdf->Cell(30, 3, iconv("UTF-8", "ISO-8859-2", "A kért alkatrész, javítás, adapter, egyéb leírása:"));
    $pdf->Ln();
    $pdf->SetFont('Arial', '', 10);
    $pdf->MultiCell(140, 4, iconv("UTF-8", "ISO-8859-2", $_REQUEST['desc']));
    $pdf->Cell(35, 10);
    $pdf->Ln();
    ...
    $email_subject = "Bérleti ajánlatkérés"; // The Subject of the email 
    $email_message = "Az ajánlatkérés tartalma a csatolt pdf fájlban található."; // Message that the email has in it 
