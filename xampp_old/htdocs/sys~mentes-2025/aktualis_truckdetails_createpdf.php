...
$pdf->Image('https://'.($_SERVER['HTTP_HOST']).'/newqr/?text='.urlencode('https://'.($_SERVER['HTTP_HOST']).'/sys/aktualis_ajax_truck_details.php?lang=hun&id='.($truck['truck_id']).'#'.($truck['truck_saxon-id'])),120,33,60,60,'png');
...
if (special_offer_active($truck) AND 0) {
    $pdf->Cell(83, 7, "");
